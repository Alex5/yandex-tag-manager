		...
		<section className="mx-auto max-w-3xl py-12">
			<div className="flex flex-col gap-6">
				...
				<div className="border p-2 rounded-xl">
					...
					<p
						id="patient-name"
						data-patientname="Соснин Илья2 Андреевич, 06.10.1990, Медкарта CLBMDX3"
					>
				...
				<div className="flex flex-col gap-6">
					<article
						data-productid={16}
						id="product"
						className="border flex flex-col gap-2 p-2 rounded-xl"
					>
						<b>16</b>
							...
							<DialogContent id="add-rec-dialog" data-originproductid={16}>
								...
								<ul className="w-full">
									{[
										...
										<li
											key={item}
											className="flex w-full items-center justify-between add-recommendation p-2 hover:bg-neutral-100 active:bg-neutral-200 rounded-xl"
										>
											<span data-productname={item}>{item}</span>
											<Button
												data-recommendationid={item.split(".").at(0)}
												size="icon"
												id="add-rec-btn"
					...
					<article
						data-originproductid={56}
						id="product"
						className="border flex flex-col gap-2 p-2 rounded-xl"
					>
						<b>56</b>
						<p>
							Тиреотропный гормон (ТТГ, тиротропин) (Thyroid Stimulating
							Hormone, TSH)
						</p>
						<Dialog>
							<DialogTrigger asChild>
