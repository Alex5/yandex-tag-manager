          ...
          <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-6">
                  <article data-productid={16} id="product" className="border flex flex-col gap-2 p-2 rounded-xl">
                      ...
                      <ul>
                          <li>
                              <button data-recommendationid={18} id="recommendation-product" className="add-recommendation p-2 hover:bg-neutral-100 active:bg-neutral-200 rounded-xl">
                                  18. HbA1c (гликированный Hb)
                              </button>
                          </li>
                          <li >
                              <button data-recommendationid={119} id="recommendation-product" className="add-recommendation p-2 hover:bg-neutral-100 active:bg-neutral-200 rounded-xl">
                                  119. Лейкоцитарная формула
                              </button>
                          </li>
                          <li>
                              <button data-recommendationid={11} id="recommendation-product" className="add-recommendation p-2 hover:bg-neutral-100 active:bg-neutral-200 rounded-xl">
                                  11. Альфа-амилаза
                              </button>
                          </li>
                          <li>
                              <button data-recommendationid={"ОБС73"} id="recommendation-product" className="add-recommendation p-2 hover:bg-neutral-100 active:bg-neutral-200 rounded-xl">
